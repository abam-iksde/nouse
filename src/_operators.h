...
namespace nouse {
	Value* operator_IsEqual(Context* ctx, i64 branch,i64 line, i64 fileind) {
		...
		if (args.size() == 2) {
			if (args[0]->getType() == ValueType::INT && args[1]->getType() == ValueType::INT) {
				result->setBoolean(args[0]->getInt() == args[1]->getInt());
			}
			else if (args[0]->getType() == ValueType::INT && args[1]->getType() == ValueType::FLOAT) {
				result->setBoolean(args[0]->getInt() == args[1]->getFloat());
			}
			else if (args[0]->getType() == ValueType::FLOAT && args[1]->getType() == ValueType::INT) {
				result->setBoolean(args[0]->getFloat() == args[1]->getInt());
			}
			else if (args[0]->getType() == ValueType::FLOAT && args[1]->getType() == ValueType::FLOAT) {
				result->setBoolean(args[0]->getFloat() == args[1]->getFloat());
			}
			else if (args[0]->getType() == ValueType::BOOLEAN && args[1]->getType() == ValueType::BOOLEAN) {
				result->setBoolean(args[0]->getBoolean() == args[1]->getBoolean());
			}
			else if (args[0]->getType() == ValueType::STRING && args[1]->getType() == ValueType::STRING) {
				result->setBoolean(args[0]->getString()->value == args[1]->getString()->value);
			}
			else if (args[0]->getType() == ValueType::_ERROR && args[1]->getType() == ValueType::STRING) {
				result->setBoolean(args[0]->getString()->value == args[1]->getString()->value);
			}
			else if (args[0]->getType() == ValueType::STRING && args[1]->getType() == ValueType::_ERROR) {
				result->setBoolean(args[0]->getString()->value == args[1]->getString()->value);
			}
			else if (args[0]->getType() == ValueType::_ERROR && args[1]->getType() == ValueType::_ERROR) {
				result->setBoolean(args[0]->getString()->value == args[1]->getString()->value);
			}
			else {
	...
	Value* operator_IsSmallerOrEqual(Context* ctx, i64 branch,i64 line, i64 fileind) {
		Value* result = new Value();
		std::vector< nouse::Value* > args = ctx->getTopFunctionArgs();
		if (args.size() == 2) {
			if (args[0]->getType() == ValueType::INT && args[1]->getType() == ValueType::INT) {
	...
	Value* operator_IsGreaterOrEqual(Context* ctx, i64 branch,i64 line, i64 fileind) {
		Value* result = new Value();
		std::vector< nouse::Value* > args = ctx->getTopFunctionArgs();
		if (args.size() == 2) {
			if (args[0]->getType() == ValueType::INT && args[1]->getType() == ValueType::INT) {
	...
	Value* operator_Add(Context* ctx, i64 branch,i64 line, i64 fileind) {
		...
		if (args[0]->getType() == ValueType::INT && args[1]->getType() == ValueType::INT) {
			...
			Value* result = new Value();
			String* _s = new String(args[0]->getString()->value + args[1]->getString()->value);
			result->setString(_s);
			delete _s;
			return result;
		}
		else {
			if (showErrors()) std::cout << "NOUSE ERROR file: '" << *getSourceFileName(fileind) << "' line: " << line << ": cannot add two values of types '" << getValueTypeName(args[0]->getType()) << "' and '" << getValueTypeName(args[1]->getType()) << '\'' << std::endl;
			Value* result = new Value();
	...
	Value* operator_Sub(Context* ctx, i64 branch,i64 line, i64 fileind) {
		...
		else if (args[0]->getType() == ValueType::NONE && args[1]->getType() == ValueType::INT) {
			Value* result = new Value();
			result->setInt(-args[1]->getInt());
			return result;
		}
		else if (args[0]->getType() == ValueType::NONE && args[1]->getType() == ValueType::FLOAT) {
			Value* result = new Value();
			result->setFloat(-args[1]->getFloat());
			return result;
		}
		else {
			if (showErrors()) std::cout << "NOUSE ERROR file: '" << *getSourceFileName(fileind) << "' line: " << line << ": cannot subtract two values of types '" << getValueTypeName(args[0]->getType()) << "' and '" << getValueTypeName(args[1]->getType()) << '\'' << std::endl;
			Value* result = new Value();
			String* _s = new String("CalcTypeMismatch");
			result->setError(_s);
			delete _s;
	...
	Value* operator_Mult(Context* ctx, i64 branch,i64 line, i64 fileind) {
		...
		if (args[0]->getType() == ValueType::INT && args[1]->getType() == ValueType::INT) {
			...
			if (showErrors()) std::cout << "NOUSE ERROR file: '" << *getSourceFileName(fileind) << "' line: " << line << ": cannot add multiply values of types '" << getValueTypeName(args[0]->getType()) << "' and '" << getValueTypeName(args[1]->getType()) << '\'' << std::endl;
			Value* result = new Value();
			String* _s = new String("CalcTypeMismatch");
			result->setError(_s);
			delete _s;
	...
	Value* operator_Div(Context* ctx, i64 branch,i64 line, i64 fileind) {
		...
		if (args[0]->getType() == ValueType::INT && args[1]->getType() == ValueType::INT) {
			...
			if (showErrors()) std::cout << "NOUSE ERROR file: '" << *getSourceFileName(fileind) << "' line: " << line << ": cannot add divide values of types '" << getValueTypeName(args[0]->getType()) << "' and '" << getValueTypeName(args[1]->getType()) << '\'' << std::endl;
			Value* result = new Value();
			String* _s = new String("CalcTypeMismatch");
			result->setError(_s);
			delete _s;
	...
	Value* operator_Modulo(Context* ctx, i64 branch,i64 line, i64 fileind) {
		...
		if (args[0]->getType() == ValueType::STRING) {
		...
		else if (args[0]->getType() == ValueType::INT && args[1]->getType() == ValueType::INT) {
			Value* result = new Value();
			result->setInt(args[0]->getInt() % args[1]->getInt());
			return result;
		}
			...
			if (showErrors()) std::cout << "NOUSE ERROR file: '" << *getSourceFileName(fileind) << "' line: " << line << ": cannot perform '%' operation with '" << getValueTypeName(args[0]->getType()) << "' and '" << getValueTypeName(args[1]->getType()) << '\'' << std::endl;
			Value* result = new Value();
	...
	Value* operator_If(Context* ctx, i64 branch,i64 line, i64 fileind) {
		...
		if (args.size() == 2) {
			...
			if (showErrors()) std::cout << "NOUSE ERROR file: '" << *getSourceFileName(fileind) << "' line: " << line << ": second argument of '?' operator has to be function or (fun_if_b_true, fun_if_b_false) tuple, got " << getValueTypeName(args[1]->getType()) << std::endl;
	...
	Value* operator_Do(Context* ctx, i64 branch,i64 line, i64 fileind) {
		...
		if (args.size() == 2) {
			...
			if (cond->getType() == ValueType::FUNCTION) {
				Value* fun = args[1];
				if (fun->getType() != ValueType::FUNCTION && fun->getType() != ValueType::NATIVE_FUNCTION) {
					if (showErrors()) std::cout << "NOUSE ERROR file: '" << *getSourceFileName(fileind) << "' line: " << line << ": second argument of 'do' operator has to be a function or a native function" << std::endl;
					Value* result = new Value();
				...
				if (showErrors()) std::cout << "NOUSE ERROR file: '" << *getSourceFileName(fileind) << "' line: " << line << ": first argument of 'do' operator has to be a function or a none-type" << std::endl;
				Value* result = new Value();
	...
	Value* operator_With(Context* ctx, i64 branch,i64 line, i64 fileind) {
		...
		if (args.size() >= 2) {
			if (args[0]->getType() != ValueType::OBJECT) {
				if (showErrors()) std::cout << "NOUSE ERROR file: '" << *getSourceFileName(fileind) << "' line: " << line << ": first argument of '->' has to be an object" << std::endl;
				Value* result = new Value();
				String* _s = new String("InvalidArgument");
				result->setError(_s);
				delete _s;
				...
				if (showErrors()) std::cout << "NOUSE ERROR file: '" << *getSourceFileName(fileind) << "' line: " << line << ": second argument of '->' has to be a function" << std::endl;
				Value* result = new Value();
				String* _s = new String("InvalidArgument");
				result->setError(_s);
				delete _s;
	...
	Value* operator_DoInCurrentBranch(Context* ctx, i64 branch, i64 line, i64 fileind) {
		branch--;
		Value* result = nullptr;
		std::vector< Value* > args = ctx->getTopFunctionArgs();
		if (args.size() >= 2) {
			...
			if (args[0]->getType() == ValueType::FUNCTION) {
				...
				if (showErrors()) std::cout << "NOUSE ERROR file: '" << *getSourceFileName(fileind) << "' line: " << line << ": trying to call a value of type '" << getValueTypeName(args[0]->getType()) << '\'' << std::endl;
				result = new Value();
			...
			if (showErrors()) std::cout << "NOUSE ERROR file: '" << *getSourceFileName(fileind) << "' line: " << line << ": malformed '@' function call" << std::endl;
		}
		return result;
	}

	Value* operator_DoInCurrentScope(Context* ctx, i64 branch, i64 line, i64 fileind) {
		branch--;
		Value* result = nullptr;
		std::vector< Value* > args = ctx->getTopFunctionArgs();
		if (args.size() >= 2) {
