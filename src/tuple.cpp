...
NativeFunction* interpretTupleLiteral() { return nfInterpretTupleLiteral; }
void initTuple() {
...
Value* Tuple::getAt(i64 ind) { return stuff[ind]; }
i64 Tuple::length() { return stuff.size(); }
std::vector< Value* >& Tuple::data() { return stuff; }
